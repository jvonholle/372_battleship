...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				else 
				{
					if (shoot == 'H')
					{
						...
						if (AIbehavior == 0) // this probably cnan be combined lower but debugging
						{
							originalCharHit = tempxcoord;
							originalIntHit = tempycoord;
						}
						if (AIbehavior == 0)
						{
							AIbehavior = 1;
